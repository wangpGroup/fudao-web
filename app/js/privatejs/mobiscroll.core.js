...
// mobiscroll.core.js end

// mobiscroll.frame.js being
...
// mobiscorll.frame.js end

//mobiscroll.scroller.js being
(function ($, window, document, undefined) {
...
// mobiscroll.scroller.js end

// mobiscroll.util.datetime.js being
(function ($, undefined) {
    var ms = $.mobiscroll;
...
// mobiscroll.util.datetime.js end
var pregnancy_date_defaults;
// mobiscroll.datetimebase.js being
(function ($, undefined) {
    var ms = $.mobiscroll,
        datetime = ms.datetime,
        date = new Date();
        pregnancy_date_defaults = {
            startYear: date.getFullYear() - 100,
            endYear: date.getFullYear() - 14,
            separator: ' ',
            // Localization
            dateFormat: 'mm-dd-yy',
            dateOrder: 'mmddy',
        ...
        preset = function (inst) {
            ...
            var i,
                ...
                s = $.extend(inst.settings, ms.datetime.defaults, pregnancy_date_defaults, html5def, orig),
                offset = 0,
                validValues = [],
                wheels = [],
                ord = [],
...
// mobiscroll.datetimebase.js end

// mobiscroll.datetime.js being
(function ($) {
...
// mobiscroll.datetime.js end

// mobiscroll.select.js being
(function ($, undefined) {
    var ms = $.mobiscroll,
        util = ms.util,
        isString = util.isString,
    ...
    ms.presets.scroller.select = function (inst) {
        ...
        if (elm.next().is('input.mbsc-control')) {
            ...
            input = $('<input type="hidden" id="' + id + '" class="mbsc-control mbsc-control-ev ' + s.inputClass + '" readonly />');
...
// mobiscroll.select.js end

// mobiscroll.mobiscroll-dark.js being
(function ($) {
...
// mobiscroll.mobiscroll-dark.js end

// mobiscroll.i18n.zh.js being
(function ($) {
    $.mobiscroll.i18n.zh = {
        // Core
        setText: '确定',
