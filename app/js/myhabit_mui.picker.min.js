	...
	e.DtPicker = e.Class.extend({
		init: function(n) {
			...
			s.cancel.addEventListener("tap",
				...
				s.h.addEventListener("change",
					function(e) {
						a._createMinutes('change', a.getSelected())
					}, !1),
		...
		_createHours: function(e) {
			...
			if(e == undefined) {
				...
				n.h.picker.setItems(e)
			}
		},
		_createMinutes: function(e, _time) {
			var t = this,
				i = t.options,
				n = t.ui,
				a = [];
			...
			if(e == undefined) {
				...
				n.i.picker.setItems(e)
			} else if(e == "change") {
				if(_time != undefined) {
					_time = _time.toString().split(":")[0];
					var _minute = [];
					for(var _m in picker_json[_time]) {
						var _m_j = {};
						_m_j["text"] = picker_json[_time][_m];
						_m_j['value'] = picker_json[_time][_m];
						_minute.push(_m_j);
					}
					n.i.picker.setItems(_minute)
				}
			}
